...
export function RunTracker(){
  return (
    <Card className="border-emerald-500/20">
      <CardHeader><CardTitle className="flex items-center gap-2"><Map size={16} className="text-emerald-400"/> Run Social <Badge variant="muted">runFlutterRun MIT</Badge></CardTitle><p className="text-xs text-zinc-500">Outdoor tracker + social: corre, comparte, comenta</p></CardHeader>
      <CardContent className="space-y-3">
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-3 space-y-2">
          ...
          <div className="flex gap-2 items-center"><div className="w-6 h-6 rounded-full bg-[#D6FF2A] text-black flex items-center justify-center font-black text-[11px]">E</div><p className="text-xs"><span className="font-bold">Ezequiel:</span> Excelente, subimos 500m la próxima.</p></div>
        ...
        <p className="text-[11px] text-zinc-600 text-center">runFlutterRun MIT (Flutter+Java) — outdoor + social</p>
      </CardContent>
    </Card>
  );
}
