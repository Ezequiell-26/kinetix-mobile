...
export function LiveSession(){
    ...
    return (
      <Card className="border-emerald-500/20 bg-zinc-950 overflow-hidden">
        <div className="aspect-video bg-zinc-900 flex flex-col items-center justify-center gap-2 p-4">
          <div className="w-16 h-16 rounded-full bg-primary flex items-center justify-center font-black text-black text-xl">E</div>
  ...
  return (
    <Card className="border-violet-500/20">
      <CardHeader><CardTitle className="flex items-center gap-2"><Video size={16} className="text-violet-400"/> Live Session</CardTitle><p className="text-xs text-zinc-500">Video 1:1 WebRTC — corrección técnica en vivo, sin Zoom</p></CardHeader>
