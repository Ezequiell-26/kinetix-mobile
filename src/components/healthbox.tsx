...
export function HealthBox(){
  return (
    <Card>
      <CardHeader><CardTitle className="flex items-center gap-2"><Heart size={16} className="text-red-400"/> HealthBox <Badge variant="muted">HealthKit MIT</Badge></CardTitle><p className="text-xs text-zinc-500">Todo tu salud en 1 lugar — FC, HRV, pasos, sueño</p></CardHeader>
      <CardContent className="grid grid-cols-2 gap-2">
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-3 text-center"><Smartphone size={14} className="mx-auto text-zinc-400"/><p className="font-black">8.2k</p><p className="text-[11px] text-zinc-500">Pasos hoy</p><div className="h-1 bg-zinc-800 rounded-full overflow-hidden mt-1"><div className="h-full bg-[#D6FF2A]" style={{width:"82%"}} /></div></div>
