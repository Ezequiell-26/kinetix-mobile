...
// Inspirado en Stripe Dashboard + Baremetrics MIT + Twenty CRM
// Revenue pro: MRR, ARPU, churn, LTV, expansion
    ...
    <Card className="border-emerald-500/20 bg-gradient-to-br from-emerald-500/5 via-zinc-900 to-zinc-900">
      ...
      <CardContent className="space-y-3">
        <div className="grid grid-cols-2 gap-2">
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-3 text-center"><p className="text-[11px] text-zinc-500">ARPU</p><p className="font-black text-lg">$18k</p><p className="text-[11px] text-zinc-500">por cliente</p></div>
          <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-3 text-center"><p className="text-[11px] text-zinc-500">Churn</p><p className="font-black">1.8%</p><p className="text-[11px] text-emerald-400">↓ bueno</p></div>
          <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-3 text-center"><p className="text-[11px] text-zinc-500">LTV</p><p className="font-black">$245k</p><p className="text-[11px] text-zinc-500">14 meses</p></div>
        </div>
