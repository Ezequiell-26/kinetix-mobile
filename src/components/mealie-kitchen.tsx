...
export function MealieKitchen(){
  ...
  return (
    <Card className="border-orange-500/20">
      <CardHeader><CardTitle className="flex items-center gap-2"><ChefHat size={16} className="text-orange-400"/> Mealie Kitchen</CardTitle><p className="text-xs text-zinc-500">Recetas y plan semanal de comidas</p></CardHeader>
