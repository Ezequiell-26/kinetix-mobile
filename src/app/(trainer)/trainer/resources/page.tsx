  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid sm:grid-cols-2 gap-3">
        ...
        <Card className="border-[#D6FF2A]/20 bg-[#D6FF2A]/[0.03]"><CardHeader><CardTitle>WhatsApp Business</CardTitle><p className="text-xs text-zinc-500">Conecta tu número para mensajes</p></CardHeader><CardContent><Button variant="outline" size="sm" className="w-full">Conectar</Button></CardContent></Card>
      </div>
      <Card>
