...
export default function ForgotPage(){
  ...
  async function submit(e:React.FormEvent){
    ...
    if(!res.ok){ try{ const d=await res.json(); setError(d.error||"No se pudo procesar"); }catch{ setError("No se pudo procesar"); } return; }
    setSent(true);
  }
  return (
        ...
        <CardContent>
          {!sent ? (
            ...
            <div className="text-center py-6 space-y-3">
              ...
              <p className="text-xs text-zinc-500">En desarrollo, el enlace de recuperación se imprime en la consola del servidor.</p>
