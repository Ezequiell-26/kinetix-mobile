...
export const CLIENT_NAV: NavEntry[] = [
  ...
  { href: "/client/messages", label: "Mensajes", group: "Navegación", desc: "Chat con Ezequiel" },
  ...
  { href: "/client/tools?cat=educacion", label: "Educación", group: "Herramientas", desc: "Wiki de Ezequiel" },
