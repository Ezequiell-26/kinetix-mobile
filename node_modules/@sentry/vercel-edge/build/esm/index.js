...
import { ServerRuntimeClient, applySdkMetadata, spanToJSON, SEMANTIC_ATTRIBUTE_SENTRY_SOURCE, hasSpansEnabled, spanToTraceContext, getRootSpan, getDynamicSamplingContextFromSpan, setAsyncContextStrategy, getClient, hasSpanStreamingEnabled, addChildSpanToSpan, getDefaultIsolationScope, getDefaultCurrentScope, setCapturedScopesOnSpan, logSpanStart, logSpanEnd, shouldIgnoreSpan, SEMANTIC_ATTRIBUTE_SENTRY_OP, baggageHeaderToDynamicSamplingContext, parseSampleRate, _INTERNAL_safeMathRandom, sampleSpan, debug, SEMANTIC_ATTRIBUTE_SENTRY_SAMPLE_RATE, SDK_VERSION, LRUMap, shouldPropagateTraceForUrl, parseBaggageHeader, SENTRY_BAGGAGE_KEY_PREFIX, generateSentryTraceHeader, generateTraceparentHeader, spanIsIgnored, spanIsSentrySpan, spanIsSampled, getCurrentScope, generateTraceId, generateSpanId, getCapturedScopesOnSpan, dynamicSamplingContextToSentryBaggageHeader, isContinuingTrace, _INTERNAL_safeDateNow, debounce, timedEventsToMeasurements, captureEvent, SPAN_KIND, safeSetSpanJSONAttributes, spanKindToName, getDynamicSamplingContextFromScope, getIsolationScope, propagationContextFromHeaders, shouldContinueTrace, isObjectLike as isObjectLike$1, derefWeakRef, handleCallbackErrors, convertSpanLinksForEnvelope, getStatusMessage, spanTimeInputToSeconds, SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN, SEMANTIC_ATTRIBUTE_SENTRY_CUSTOM_SPAN_NAME, SPAN_STATUS_OK, SPAN_STATUS_ERROR, parseUrl, getSanitizedUrlString, stripUrlQueryAndFragment, getSpanStatusFromHttpCode, addNonEnumerableProperty, makeWeakRef, defineIntegration, addFetchInstrumentationHandler, isSentryRequestUrl, instrumentFetchRequest, stringMatchesSomePattern, addBreadcrumb, getBreadcrumbLogLevelFromHttpStatusCode, createTransport, suppressTracing as suppressTracing$2, SENTRY_BUFFER_FULL_ERROR, GLOBAL_OBJ, createStackParser, nodeStackLineParser, dedupeIntegration, inboundFiltersIntegration, functionToStringIntegration, conversationIdIntegration, linkedErrorsIntegration, consoleIntegration, requestDataIntegration, getIntegrationsToSetup, stackParserFromStackParserOptions, addVercelAiProcessors } from '@sentry/core';
export { SDK_VERSION, SEMANTIC_ATTRIBUTE_SENTRY_OP, SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN, SEMANTIC_ATTRIBUTE_SENTRY_SAMPLE_RATE, SEMANTIC_ATTRIBUTE_SENTRY_SOURCE, Scope, addBreadcrumb, addEventProcessor, addIntegration, bindScopeToEmitter, captureCheckIn, captureConsoleIntegration, captureEvent, captureException, captureFeedback, captureMessage, close, consoleIntegration, consoleLoggingIntegration, continueTrace, createConsolaReporter, createLangChainCallbackHandler, createTransport, dedupeIntegration, eventFiltersIntegration, extraErrorDataIntegration, featureFlagsIntegration, flush, functionToStringIntegration, getActiveSpan, getClient, getCurrentScope, getGlobalScope, getIsolationScope, getRootSpan, getSpanDescendants, getSpanStatusFromHttpCode, getTraceData, getTraceMetaTags, inboundFiltersIntegration, instrumentAnthropicAiClient, instrumentGoogleGenAIClient, instrumentLangChainEmbeddings, instrumentLangGraph, instrumentOpenAiClient, instrumentStateGraph, instrumentSupabaseClient, isEnabled, isInitialized, lastEventId, linkedErrorsIntegration, logger, metrics, moduleMetadataIntegration, requestDataIntegration, rewriteFramesIntegration, setAttribute, setAttributes, setContext, setCurrentClient, setExtra, setExtras, setHttpStatus, setMeasurement, setTag, setTags, setUser, spanStreamingIntegration, spanToBaggageHeader, spanToJSON, spanToTraceHeader, startInactiveSpan, startNewTrace, startSpan, startSpanManual, supabaseIntegration, suppressTracing, trpcMiddleware, withActiveSpan, withIsolationScope, withMonitor, withScope, withStreamedSpan, wrapMcpServerWithSentry, zodErrorsIntegration } from '@sentry/core';
import * as api from '@opentelemetry/api';
import { createContextKey, baggageEntryMetadataFromString, propagation, diag, SpanStatusCode, trace, isSpanContextValid, TraceFlags, createNoopMeter, isValidTraceId, ROOT_CONTEXT, SpanKind, INVALID_TRACEID, context, DiagLogLevel } from '@opentelemetry/api';
...
class SpanImpl {
  ...
  constructor(opts) {
    ...
    __publicField$7(this, "endTime", [0, 0]);
    __publicField$7(this, "_ended", false);
    __publicField$7(this, "_duration", [-1, -1]);
...
function spanHasAttributes(span) {
  const castSpan = span;
  return isObjectLike$1(castSpan.attributes);
}
