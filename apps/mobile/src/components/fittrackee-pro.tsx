...
export function FitTrackeePro(){
  return (
    <Card className="border-emerald-500/20">
      <CardHeader><CardTitle className="flex items-center gap-2"><Map size={16} className="text-emerald-400"/> FitTrackee Pro</CardTitle><p className="text-xs text-zinc-500">Mapa GPX + elevación + velocidad — Ruby + GPX</p></CardHeader>
