...
export function OnboardingVideo(){
  return (
    <Card className="border-primary/20 bg-gradient-to-br from-primary/5 via-zinc-900 to-zinc-900">
      <CardHeader><CardTitle className="flex items-center gap-2"><Play size={16} className="text-primary"/> Bienvenida de KinetixFitt <Badge variant="accent">Onboarding</Badge></CardTitle><p className="text-xs text-zinc-500">Video 45s + test de movimiento inicial</p></CardHeader>
      <CardContent className="space-y-3">
        <div className="aspect-video rounded-xl bg-zinc-900 border border-zinc-800 flex flex-col items-center justify-center gap-2">
          ...
          <p className="text-xs font-bold">Video bienvenida — KinetixFitt</p>
          <p className="text-[11px] text-zinc-500">Hola, soy tu coach de KinetixFitt. Bienvenido a tu transformación.</p>
        </div>
