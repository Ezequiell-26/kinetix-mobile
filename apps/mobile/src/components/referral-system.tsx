  ...
  return (
    <Card className="border-emerald-500/20 bg-gradient-to-br from-emerald-500/5 via-zinc-900 to-zinc-900">
      ...
      <CardContent className="space-y-3">
        ...
        <Button variant="outline" className="w-full" onClick={()=>{ if(navigator.share) navigator.share({title:"KinetiX", text:"Entrena con Ezequiel — 1 mes gratis con mi link", url:link}).catch(()=>{}); else copy(); }}><Share2 size={14} className="mr-2"/> Compartir link</Button>
      </CardContent>
    </Card>
  );
}
