...
const CalorieCalculator = dynamic(() => import("@/components/calorie-calculator").then(m => m.CalorieCalculator), { ssr: false, loading: () => <ChartSkeleton height={260} /> });
const OneRMCalculator = dynamic(() => import("@/components/calorie-calculator").then(m => m.OneRMCalculator), { ssr: false, loading: () => <ChartSkeleton height={200} /> });
import { Card, CardContent } from "@/components/ui/card";
import { Badge } from "@/components/ui/badge";
const BarcodeScanner = dynamic(() => import("@/components/barcode-scanner").then(m => m.BarcodeScanner), { ssr: false, loading: () => <ChartSkeleton height={160} /> });
const FoodDatabase = dynamic(() => import("@/components/food-database").then(m => m.FoodDatabase), { ssr: false, loading: () => <ChartSkeleton height={200} /> });
const SparkyHabits = dynamic(() => import("@/components/sparky-habits").then(m => m.SparkyHabits), { ssr: false, loading: () => <ChartSkeleton height={140} /> });
const CalculatorsHub = dynamic(() => import("@/components/calculators-hub").then(m => m.CalculatorsHub), { ssr: false, loading: () => <ChartSkeleton height={160} /> });
const OpenFoodFactsPro = dynamic(() => import("@/components/openfoodfacts-pro").then(m => m.OpenFoodFactsPro), { ssr: false, loading: () => <ChartSkeleton height={160} /> });
const MealieKitchen = dynamic(() => import("@/components/mealie-kitchen").then(m => m.MealieKitchen), { ssr: false, loading: () => <ChartSkeleton height={160} /> });
const NutritionPro = dynamic(() => import("@/components/nutrition-pro").then(m => m.NutritionPro), { ssr: false, loading: () => <ChartSkeleton height={160} /> });
const AiMealPlanner = dynamic(() => import("@/components/ai-meal-planner").then(m => m.AiMealPlanner), { ssr: false, loading: () => <ChartSkeleton height={160} /> });
const MacroTiming = dynamic(() => import("@/components/macro-timing").then(m => m.MacroTiming), { ssr: false, loading: () => <ChartSkeleton height={160} /> });
