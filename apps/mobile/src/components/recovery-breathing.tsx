...
export function RecoveryBreathing(){
  ...
  return (
    <Card className="border-sky-500/20">
      <CardHeader><CardTitle className="flex items-center gap-2"><Wind size={16} className="text-sky-400"/> Recovery Breathing</CardTitle><p className="text-xs text-zinc-500">Box breathing 4-4-4-4 — recuperación + foco</p></CardHeader>
