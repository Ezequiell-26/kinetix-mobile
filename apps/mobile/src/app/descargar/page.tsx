      ...
      <main className="mx-auto max-w-5xl px-4 py-14">
        ...
        <div className="mt-10 grid sm:grid-cols-3 gap-4">
          <article className="rounded-2xl border border-zinc-800 bg-zinc-950 p-6 flex flex-col">
            <Smartphone size={26} className="text-[#34D399]" />
            ...
            <Link
              href="/install"
              className="mt-5 min-h-[48px] inline-flex items-center justify-center rounded-full bg-[#34D399] text-black text-sm font-black"
            >
              Instalar ahora
            </Link>
          </article>
          ...
          <article className="rounded-2xl border border-zinc-800 bg-zinc-950 p-6 flex flex-col">
            <MonitorDown size={26} className="text-[#34D399]" />
            ...
            <Link
              href="/install"
              className="mt-5 min-h-[48px] inline-flex items-center justify-center rounded-full border border-zinc-700 text-sm font-black hover:border-[#34D399]"
            >
              Cómo instalarla
            </Link>
          </article>

          <article className="rounded-2xl border border-[#34D399] bg-[#34D399]/5 p-6 flex flex-col">
            <KeyRound size={26} className="text-[#34D399]" />
            ...
            <Link
              href="/register"
              className="mt-5 min-h-[48px] inline-flex items-center justify-center gap-2 rounded-full bg-[#34D399] text-black text-sm font-black"
            >
