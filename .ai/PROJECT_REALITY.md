...
| --------------------------------------------- | --------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `/` landing + panel                         | IMPLEMENTED     | Landing EZEQUIEL COACHING (hero, 6 funciones, 3 pasos, 3 planes ARS del seed) verificada visual 2026-09-12. Redirect con sesión vía **middleware** (307): el `redirect()` en el Server Component se serializaba como error NEXT_REDIRECT en el stream RSC. Metadata/OG a EZEQUIEL COACHING. Pendiente: unificar identidad KinetixFitt vs EZEQUIEL COACHING. |
